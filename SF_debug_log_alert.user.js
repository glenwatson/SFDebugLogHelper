...
parseBtn.setAttribute('onclick', 'document.getElementsByTagName("body")[0].insertBefore(logTreeToDivs(parselog()), document.getElementsByTagName("pre")[0]);');
parseBtn.innerHTML = 'To Tree';
